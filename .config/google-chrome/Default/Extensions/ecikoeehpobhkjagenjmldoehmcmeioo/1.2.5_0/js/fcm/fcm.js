    ...
    getFirebaseMessaging (senderId) {
        ...
        if (!alreadyInited) {
            existingApp = firebase.initializeApp({
                ...
                apiKey: "AIzaSyCfuL0uN3idAT9Lt77Gn-0l7JEJ9eRXUmo",
                authDomain: "escorregaoprecov1.firebaseapp.com",
                databaseURL: "https://escorregaoprecov1.firebaseio.com",
                projectId: "escorregaoprecov1",
                storageBucket: "escorregaoprecov1.appspot.com",
                appId: "1:143005103151:web:62b7bd149efbfb145102da",
                measurementId: "G-C4YB88SJ65"
